...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var baseWidth = parseInt(zoomableImage.getAttribute('data-base-width'), 10) || zoomableImage.clientWidth || 600;
  var maxWidth = parseInt(zoomableImage.getAttribute('data-max-width'), 10) || 1200;
